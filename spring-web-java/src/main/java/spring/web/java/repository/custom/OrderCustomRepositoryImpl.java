...
import static spring.web.java.domain.QDelivery.delivery;
import static spring.web.java.domain.QMember.member;
import static spring.web.java.domain.QOrder.order;
