package spring.web.java.infrastructure.aspect;
...
import spring.web.java.application.service.RequestLockService;
...
public class RequestLockAspect {
	...
	@Pointcut("@annotation(spring.web.java.infrastructure.aspect.RequestLock)")
